...
var moviesRules2 = ['no-large-media: behind-the-scene false','behind-the-scene * * noop','behind-the-scene * 1p-script noop','behind-the-scene * 3p noop','behind-the-scene * 3p-frame noop','behind-the-scene * 3p-script noop','behind-the-scene * image noop','behind-the-scene * inline-script noop','* Imdb.com * allow','* Ign.com * allow','* Rottentomatoes.com * allow','* Fandango.com * allow','* Filmaffinity.com * allow','* Boxofficemojo.com * allow','* Indiewire.com * allow','* Asianwiki.com * allow','* Creativecow.net * allow','* Roosterteeth.com * allow','* Amctheatres.com * allow','* Moviefone.com * allow','* Whatculture.com * allow','* Regmovies.com * allow','* Cinemark.com * allow','* Rogerebert.com * allow','* Comicbookmovie.com * allow','* Imdb.com/chart/top * allow','* Movieweb.com * allow','* Cineworld.co.uk * allow','* Drafthouse.com * allow','* Comingsoon.net * allow','* Imdb.com/oscars/ * allow','* Odeon.co.uk * allow','* Movieinsider.com * allow','* Bfi.org.uk * allow','* Bloody-disgusting.com * allow','* Myvue.com * allow','* Empireonline.com * allow','* Topdocumentaryfilms.com * allow','* Starwars.com * allow','* Filmschoolrejects.com * allow','* Imdb.com/movies-coming-soon/ * allow','* Hoyts.com.au * allow','* Movietickets.com * allow','* Criterion.com * allow','* Joblo.com * allow','* Warnerbros.com * allow','* Traileraddict.com * allow','* Thecinemaholic.com * allow','* Filmsite.org * allow','* Mpaa.org * allow','* What-song.com * allow','* Marcustheatres.com * allow','* Darkhorizons.com * allow','* The-numbers.com * allow','* Nyfa.edu * allow','* Landmarktheatres.com * allow','* Villagecinemas.com.au * allow','* Tgv.com.my * allow'];
var moviesRules = ['no-large-media: behind-the-scene false','behind-the-scene * * noop','behind-the-scene * 1p-script noop','behind-the-scene * 3p noop','behind-the-scene * 3p-frame noop','behind-the-scene * 3p-script noop','behind-the-scene * image noop','behind-the-scene * inline-script noop','* fandango.com * allow','* media-imdb.com * allow','no-cosmetic-filtering: www.imdb.com true'];

var commitAllHandlerMovie = function() {
    // applyDiff(false, moviesRules.join(''), '');


    // var toAdd = moviesRules, toRemove = [];
...
uDom('#f1').on('click', fileReaderOnLoadHandler2);
